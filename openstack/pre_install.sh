...
sed -i 's/network.target/network-online.target/g' /etc/systemd/system/multi-user.target.wants/memcached.service
sed -i 's/network.target/network-online.target/g' /etc/systemd/system/multi-user.target.wants/rabbitmq-server.service